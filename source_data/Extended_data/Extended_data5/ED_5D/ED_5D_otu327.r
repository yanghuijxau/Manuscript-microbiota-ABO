...
library(ggplot2)
library(plyr) 
setwd("/Users/zhangwanchang/Desktop/manuscript/submission_3/data&scripts/Supp_Figures/FigS5.1/SFig5.1D")
df = read.table(file="ED_5D_Otu327.txt",header=T)
